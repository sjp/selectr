test_that("adjacent sibling combinator generates simplified XPath", {
    ...
    expect_equal(xpath('a + b'),
                 "a/following-sibling::*[1][self::b]")

    # With attribute on right side
    expect_equal(xpath('a + b[id]'),
                 "a/following-sibling::*[1][self::b][@id]")
    ...
    expect_equal(xpath('a + b[id][title]'),
