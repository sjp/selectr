...
test_that("selection works correctly on a large barrage of tests", {
    ...
    expect_that(pcss('li:nth-last-child(0)'), equals('seventh-li'))
    expect_that(pcss('li:nth-last-child(2n)', 'li:nth-last-child(even)'), equals(c('second-li', 'fourth-li', 'sixth-li')))
    expect_that(pcss('li:nth-last-child(2n+2)'), equals(c('second-li', 'fourth-li')))
    ...
    expect_that(pcss('ol:nth-last-of-type(1)'), equals('first-ol'))
