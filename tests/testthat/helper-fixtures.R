...
# Used by test-shakespeare-XML.R and test-shakespeare-xml2.R. The
# xml2 variant used to carry a second copy missing the <head> block
# (and an "<html>" line commented out) -- an accidental drift, not a
# deliberate difference, so the merged fixture keeps <head>.
fixture_html_shakespeare <- function() {
    paste(
